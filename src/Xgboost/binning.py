...
# First pre-sort each feature, then cut each feature into max_bin bins with equal distinct value
# in this implement, uint8 is used to represent the feature value after bining.
